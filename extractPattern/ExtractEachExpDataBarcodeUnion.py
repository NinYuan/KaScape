...
import os
import datetime
from tool.getAlignment import getAlignment60Mseq12Barcode
import pickle
from tool.extractN import Union2RandNBarcode,extractNRnameWithoutBarcode60M
...
#get N and data from r1 r2
def Alignment60Mseq12(filepathlist,seq1,seq2,randN,outfile,barcode,barcodeLeftRange,barcodeRightRange):
    ...
    for e in filepathlist:
        ...
        alignments60M = getAlignment60Mseq12Barcode(seq1,seq2,randN, e,barcode,barcodeLeftRange,barcodeRightRange)
...
def mergeData(extractedContent1,extractedContent2):
    ...
    extractall = Union2RandNBarcode(extractedContent1, extractedContent2)
...
# rawdataPath,date_path,fileIndex,base_dir,seq1,seq2,Nsize,excelpath,samplename
def extractNNNN(rawdataPath,fileIndex,base_dir,seq1,seq2,Nsize,excelpath,samplename,barcode,barcodeLeftRange,barcodeRightRange):
    ...
    if os.path.exists(outfile1):
        ...
        alignments60Ms1 = Alignment60Mseq12(rnmSeqQfile1, seq1, seq2, Nsize,outfile1,barcode,barcodeLeftRange,barcodeRightRange)
        del rnmSeqQfile1
        gc.collect()
    ...
    if os.path.exists(outfile2):
        ...
        alignments60Ms2 = Alignment60Mseq12(rnmSeqQfile2, seq1, seq2, Nsize, outfile2, barcode, barcodeLeftRange,barcodeRightRange)
        del rnmSeqQfile2
        gc.collect()
