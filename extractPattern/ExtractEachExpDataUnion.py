...
import pickle
from tool.extractN import Union2Data,extractNRnameWithoutBarcode60M
...
from tool.extractUtilize import extractUtilizationExcelEachFile
import gc
...
def UnionData(extractedContent1,extractedContent2):
    st = datetime.datetime.now()
    ...
    extractall = Union2Data(extractedContent1, extractedContent2)
...
def extractNNNN(rawdataPath,date_path,fileIndex,base_dir,seq1,seq2,Nsize,excelpath,samplename):
    ...
    getNout = UnionData(extractFile1, extractFile2)
    ...
    excelname = 'sequtilize' #( extractlen, dataname,excelname,excelpath)
    extractUtilizationExcelEachFile( extractlist, seqnamelist, excelname, excelpath)
